...
def get_python_path():
    ...
    if system == "windows":
        ...
        # macOS - use LibreOffice's Python for UNO support
        possible_paths = [
...
def start_office(port=2002):
    ...
    if not is_port_in_use(port):
        ...
        system = platform.system().lower()
        if system == "windows":
            profile_path = "file:///C:/Temp/LibreOfficeHeadlessProfile"
        else:
            # macOS and Linux
            import tempfile
            profile_path = f"file://{tempfile.gettempdir()}/LibreOfficeHeadlessProfile"
